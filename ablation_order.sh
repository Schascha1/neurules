...
run_script() {
    python run_method.py --method our-rule-list --dataset "$1" --n_rules $2 --outpath "results/ablation/ablation-order-" --ablation_order 1 & 
}
...
for n_rules in 10
    ...
    echo "# Date: $(date)" > "results/ablation/ablation-order-our-rule-list.csv"
    echo "Dataset;n_rules;F1;F1_std;Acc;Acc_std;AUC;AUC_std;Runtime;Runtime_std" >> "results/ablation/ablation-order-our-rule-list.csv"
